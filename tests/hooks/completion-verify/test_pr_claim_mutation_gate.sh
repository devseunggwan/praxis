...
unset PRAXIS_PR_CLAIM_BYPASS PRAXIS_PR_CLAIM_STRICT PRAXIS_HOOK_ERROR_STDERR
...
run_case advisory "claim-with-gh-api-read-only-still-fires" '{}'
...
run_case advisory "write-is-not-pr-mutation" '{}'
...
run_case advisory "prev-turn-mutation-not-evidence" '{}'
...
run_case advisory-strict "strict-mode" '{}' PRAXIS_PR_CLAIM_STRICT=1

...
Hooks are the larger half of praxis: **113 hooks**, registered at 140 points across
...
| ------ | ------- | -------------- |
| `preflight-gate` | 41 | Inspects a tool call before it runs and can deny it |
...
**One gate.** 74 of the 113 hooks declare an opt-out or tuning variable. Which variable

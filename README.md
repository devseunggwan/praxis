...
Hooks are the larger half of praxis: **109 hooks**, registered at 128 points across
...
| ------ | ------- | -------------- |
| `preflight-gate` | 39 | Inspects a tool call before it runs and can deny it |
...
**One gate.** 72 of the 109 hooks declare an opt-out or tuning variable. Which variable

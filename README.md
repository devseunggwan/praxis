...
Hooks are the larger half of praxis: **100 hooks**, registered at 115 points across
...
| `completion-verify` | 14 | Fires at `Stop` — can block a response that claims completion without evidence |
...
**One gate.** 62 of the 100 hooks declare an opt-out or tuning variable. Which variable

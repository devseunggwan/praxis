...
Hooks are the larger half of praxis: **107 hooks**, registered at 124 points across
...
| `advisory-nudge` | 46 | Prints a warning to stderr and lets the call through — 18 read a `PRAXIS_*_STRICT` variable that makes them stop the call instead |
...
**One gate.** 71 of the 107 hooks declare an opt-out or tuning variable. Which variable

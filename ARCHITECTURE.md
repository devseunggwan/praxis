...
| `n1-quantitative-claim-advisory` | PreToolUse | Advisory (stderr, never blocks) when a sample-dependent quantitative claim — a percentile / central-tendency figure, or a `PASS`-attached measurement — appears in the body of a `gh issue\|pr create/comment` with no sample size above 1 stated anywhere in that body (issue #949) | [hooks/advisory-nudge/n1-quantitative-claim-advisory/spec.md](hooks/advisory-nudge/n1-quantitative-claim-advisory/spec.md) |

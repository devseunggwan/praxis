...
| `tradeoff`               | Decision-fork cost report — scores options on reversibility / blast radius / cost-if-wrong / process cost, graded by source; stops without a table when a convention precedent is found; report-only     |

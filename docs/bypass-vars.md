...
| `PRAXIS_VERDICT_GAP_BYPASS` | `verdict-gap-coexistence-gate` | Skip the GO-verdict / unresolved-gap coexistence advisory |
...
| `PRAXIS_VERDICT_GAP_STRICT` | `verdict-gap-coexistence-gate` | Promote the GO-verdict / gap coexistence gate from advisory to block |

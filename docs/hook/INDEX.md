...
| [n1-quantitative-claim-advisory](../../hooks/advisory-nudge/n1-quantitative-claim-advisory/spec.md) | PreToolUse | Advisory when a sample-dependent quantitative claim (percentile / central tendency, or a `PASS`-attached measurement) appears in a `gh issue\|pr create/comment` body with no sample size above 1 stated anywhere in it (#949) |

...
| [block-personal-asset-leak](../../hooks/advisory-nudge/block-personal-asset-leak/spec.md) | PreToolUse | Advisory nudge (opt-in strict: block) when a `gh issue/pr` write body contains an absolute home-dotfiles path (`/Users/<name>/.claude/...`) — crude backstop for literal personal-asset path leaks; semantic leaks out of scope — issue #563 |
